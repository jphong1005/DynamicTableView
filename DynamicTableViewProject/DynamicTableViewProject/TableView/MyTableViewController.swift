...
protocol MyTableViewControllerDelegate: AnyObject {
...
class MyTableViewController: UIViewController {
    ...
    //  diffableDataSource: UITableViewDataSource 대체
    var diffableDataSource: UITableViewDiffableDataSource<Section, Feed>!
...
extension MyTableViewController {
    ...
    private func setupUI() -> Void {
        ...
        self.diffableDataSource = UITableViewDiffableDataSource<Section, Feed>(tableView: self.myTableView,  //  tableView: 연결할 테이블뷰
